 ...
 * api: (define)
 * module = GeoSolutions
 * class = GeoSolutions.Full(config)
 ...
 */
GeoSolutions.Full = Ext.extend(GeoSolutions, {
    /**
    ...
    createTools: function() {
        var tools = 
            GeoSolutions.Full.superclass.createTools.apply(this, arguments);
     ...
     *
     * ..seealso:: :method:`GeoSolutions.Full.makeLayerWizardPane`, :method:`GeoSolutions.Full.makeFinalWizardPane`
     */
