...
/** api: constructor
 *  .. class:: GeoSolutions.Wizard(config)
...
GeoSolutions.Wizard = function(config) { 
    Ext.applyIf(config, {
        layout: 'card',
        activeItem: 0,
        tbar: [],
    ...
    GeoSolutions.Wizard.superclass.constructor.call(this, config);
};

Ext.extend(GeoSolutions.Wizard, Ext.Window, {
