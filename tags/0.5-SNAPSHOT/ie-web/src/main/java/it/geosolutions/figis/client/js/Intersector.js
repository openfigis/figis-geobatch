...
/*
 * @include GeoSolutions/Wizard.js
 */ 

/**
 * api: (define)
 * module = GeoSolutions
 * class = GeoSolutions.Intersector(config)
 * extends = GeoSolutions
 */

/** api: constructor
 *  .. class:: GeoSolutions.Intersector(config)
 *
 *      Create a GeoSolutions application intended for full-screen display.
 */
GeoSolutions.Intersector = Ext.extend(GeoSolutions, {
    /**
    ...
    createTools: function() {
        var tools = 
            GeoSolutions.Intersector.superclass.createTools.apply(this, arguments);
     ...
     * :class:``GeoSolutions.Wizard`` to guide the user through customizing and 
     * exporting a map for display embedded in another website.
     *
     * ..seealso:: :method:`GeoSolutions.Intersector.makeLayerWizardPane`, :method:`GeoSolutions.Full.makeFinalWizardPane`
     */
    showEmbedWizard: function() {
        ...
        var wizard = new GeoSolutions.Wizard({
            height: 300,
            width: 400,
            resizable: false,
            modal: true,
