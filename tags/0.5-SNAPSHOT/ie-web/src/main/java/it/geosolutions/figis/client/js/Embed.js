...
/** api: constructor
 *  ..class:: GeoSolutions.Embed(config)
 *
 *  Create a GeoSolutions application suitable for embedding in larger pages.
 */
GeoSolutions.Embed = Ext.extend(GeoSolutions, {
    /**
    ...
    createTools: function() {
        var tools = GeoSolutions.Embed.superclass.createTools.apply(this, arguments);
