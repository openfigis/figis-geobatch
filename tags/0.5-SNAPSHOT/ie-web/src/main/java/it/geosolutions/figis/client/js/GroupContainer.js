...
GeoSolutions.GroupContainer = Ext.extend(GeoExt.tree.LayerContainer, {
    ...
    /**
     * Constructor: GeoSolutions.GroupContainer
     * 
     * Parameters:
     * config - {Object}
     */
    constructor: function(config) {
        ...
        GeoSolutions.GroupContainer.superclass.constructor.apply(this, arguments);
        this.on({
    ...
    render: function(bulkRender) {
        ...
        GeoSolutions.GroupContainer.superclass.render.call(this, bulkRender);
        if (first) {
            this.layerStore.on({
    ...
    onStoreAdd: function(store, records, index) {
         ...
         */
        GeoSolutions.GroupContainer.superclass.onStoreAdd.apply(this, arguments);
    ...
    onStoreRemove: function(store, record, index) {
         ...
         * TODO: http://www.geoext.org/trac/geoext/ticket/109
         */
        GeoSolutions.GroupContainer.superclass.onStoreRemove.apply(this, arguments);
        if (this.defaults && this.defaults.checkedGroup && !this._reordering) {
    ...
    addLayerNode: function(layerRecord, index) {
        if (layerRecord.get("group") == this.group) {
            GeoSolutions.GroupContainer.superclass.addLayerNode.apply(
                this, arguments
            );
        }
    },
    ...
    removeLayerNode: function(layerRecord) {
        if (layerRecord.get("group") == this.group) {
            GeoSolutions.GroupContainer.superclass.removeLayerNode.apply(
                this, arguments
            );
    	}
    },
    ...
    destroy: function() {
        ...
        GeoSolutions.GroupContainer.superclass.destroy.apply(this, arguments);
    }
