...
public class CredentialsManager {
    ...
    public CredentialsManager(String propertiesFile, String usersRoleAdmin, String usersRoleUser, long period) throws IOException {
		...
		try{
        	...
        	throw new RuntimeException("UsersCheckUtils: error on reading file properties: PROPERTIES_FILE: " + propertiesFile);
        }
        
        if(LOGGER.isInfoEnabled())LOGGER.info("Checked PROPERTIES_FILE: " + propertiesFile);
    	loadProperties();
    	if(LOGGER.isInfoEnabled())LOGGER.info("Assigned new properties from file: PROPERTIES_FILE: " + propertiesFile);
    ...
    private void loadProperties() throws IOException {
		...
		try {
		    ...
		    throw new IOException("UsersCheckUtils: error on realoading file properties: PROPERTIES_FILE: " + PROPERTIES_FILE);
		}finally{
			if(pin!=null){
    ...
    public User getUser(String usernameIn, String passwordIn) throws AccessDeniedException
    {
        ...
        try
        {
        	if(usersRoleAdmin==null && usersRoleUser == null)throw new AccessDeniedException("User not mapping");
