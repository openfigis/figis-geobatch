...
{
    private static final Logger LOGGER = LoggerFactory.getLogger(ZipStreamReader.class);
     ...
     */
    public static String getShapeFileFromURLbyZIP(String textUrl,
        String figisTmpDir, String layername) throws MalformedURLException, IOException
    {
        ...
        String destDir = figisTmpDir + System.getProperty("file.separator") +
            layername;
                                    ...
                                    // uncompress the files
        {
            ...
            try
            {
                LOGGER.trace("Extracting the zip file " + destDir +
                    System.getProperty("file.separator") + layername +
                    ".zip");
                Extract.extract(destDir + System.getProperty("file.separator") +
                    layername + ".zip");
        ...
        // name
        String shpfilename = figisTmpDir + System.getProperty("file.separator") +
            layername + System.getProperty("file.separator") + layername +
            System.getProperty("file.separator") + layername + ".shp";
    ...
    {
        java.io.BufferedInputStream sourceStream;
        sourceStream = new java.io.BufferedInputStream(new java.net.URL(textUrl).openStream());

        File destFile = new File(dest + System.getProperty("file.separator") + filename + ".zip");
        ...
        java.io.BufferedOutputStream destinationStream = new BufferedOutputStream(
                fos, 1024);
