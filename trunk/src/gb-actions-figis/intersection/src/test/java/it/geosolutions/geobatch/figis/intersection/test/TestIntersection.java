...
public class TestIntersection {
	...
	private Config initConfig(int version, String geoUrl, String geoUser, String geoPwd, String dbSchema, String dbName, String dbHost, String port, String dbUser, String dbPwd ){
	...
	public void testConfig() throws MalformedURLException {
		...
		if (currentConfig!=null) Request.deleteConfig(host, currentConfig.getConfigId());
		
		// first config, no others in the DB
		Config  config =  initConfig(1, "localhost", "admin", "password", "", "figis", "localhost", "8080", "dbuser", "dbpwd" );
		...
		Config  config2 =  initConfig(0, "localhost1", "admin1", "password1", "", "figis1", "localhost1", "9090", "dbuser1", "dbpwd1" );
