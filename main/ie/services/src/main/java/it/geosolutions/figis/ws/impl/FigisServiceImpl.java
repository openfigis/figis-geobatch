...
public class FigisServiceImpl implements FigisService
{
     ...
     *
     * @param id
     *            the id of the Config object to find
     * @return the found Config object
     * @throws ResourceNotFoundFault
     *             in case no Config where found
     */
    @Override
     ...
     *
     * @param id
     *            the id of the Intersection object to find
     * @return the found Intersection object
     * @throws ResourceNotFoundFault
     *             in case no Intersection where found
     */
    @Override
    ...
    /*****************************
     * Returns a list of Intersection instances whose srcLayer is equal to the
     * first parameter and the trgLayer is equal to the second one
     *
     * @param srcLayer
     *            the value to compare to the srcLayer attribute
     * @param trgLayer
     *            the value to compare to the trgLayer attribute
     * @return the Intersection instances found
     */
    @Override
    public Intersections getIntersectionsByLayerNames(String srcLayer,
        String trgLayer)
    {
     ...
     */
    @Override
    public IntersectionsPageCount getAllIntersectionsCount(Integer start,
        Integer limit) throws BadRequestExceptionFault
    {
        if (((start != null) && (limit == null)) ||
                ((start == null) && (limit != null)) ||
                ((limit != null) && (limit == 0)))
    ...
    /********************************************
     * Returns the total of Intersection filtered by mask nameLike: the filter:
     * it must be null to return all items
     *
     * @return all the Intersection instances
     */
    @Override
     ...
     *            the id to look up
     * @param config
     *            the Config instance containing the values to update
     ...
     *
     * @param id
     *            is the identifier of the instance to find
     * @param status
     ...
     *
     * @param id
     *            is the identifier of the instance to delete
    ...
    public boolean deleteIntersections() throws BadRequestExceptionFault
    {
        ...
        for (Intersection intersection : intersections)
        {
            try
            {
                return deleteIntersection(intersection.getId());
            }
