 ...
 * 
 * Note Process coming from the figis-wps-process Java module (For now the process
 * has been transferred to the figis-geobatch action until maven integration
 * and distribution tools will be accessible from remote. 
 * 
 * 
